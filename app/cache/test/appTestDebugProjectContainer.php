...
class appTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/assetic/config'), true)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'jobeet_test', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => 'sifast', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_c1921cd1ac0674f0c82e449e744e0ff4');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_c1921cd1ac0674f0c82e449e744e0ff4');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_c1921cd1ac0674f0c82e449e744e0ff4');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/src/Ibw/JobeetBundle/Resources/config/doctrine' => 'Ibw\\JobeetBundle\\Entity'));
        ...
        $f->setProxyDir('/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/logs/test.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test',
            ...
            'debug.container.dump' => '/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/appTestDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/sessions',
            ...
            'profiler.storage.dsn' => 'file:/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/profiler',
            ...
            'router.resource' => '/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/home/likewise-open/SIFAST/yassine.dammak/workspace/jobeet/app/cache/test/doctrine/orm/Proxies',
